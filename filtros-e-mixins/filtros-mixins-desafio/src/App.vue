...
<script>
	import funcoesMixins from '@/funcoesMixin'
	export default {
		filters: {
			trocarExpacoPorVirgula(valor) {
				return valor.replaceAll(' ', ',')
			}
		},
		mixins: [funcoesMixins]
	}
</script>
